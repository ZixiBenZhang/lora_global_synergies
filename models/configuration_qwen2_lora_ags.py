...
class Qwen2LoraAgsConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen2LoraAgsModel`]. It is used to instantiate a
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 151936):
            ...
            `inputs_ids` passed when calling [`Qwen2LoraAgsModel`]
    ...
    >>> model = Qwen2LoraAgsModel(configuration)
